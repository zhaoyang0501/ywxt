    ...
    private int updateValues(int type, String key, Object value) throws DataAccessException, PropertyException {
        ...
        switch (type) {
            case PropertySet.BOOLEAN:
                ...
                return this.getJdbcTemplate().update(sql, new Object[]{new Integer(boolVal.booleanValue() ? 1 : 0), new Integer(type), globalKey, key});
            ...
            case PropertySet.DATA:
                ...
                return this.getJdbcTemplate().update(sql, new Object[]{data.getBytes(), new Integer(type), globalKey, key});
            ...
            case PropertySet.DATE:
                ...
                return this.getJdbcTemplate().update(sql, new Object[]{new Timestamp(date.getTime()), new Integer(type), globalKey, key});
            ...
            case PropertySet.DOUBLE:
                ...
                return this.getJdbcTemplate().update(sql, new Object[]{d, new Integer(type), globalKey, key});
            ...
            case PropertySet.INT:
                ...
                sql = "UPDATE " + tableName + " SET " + colNumber + " = ?, " + colItemType + " = ? " + " WHERE " + colGlobalKey + " = ? AND " + colItemKey + " = ?";
                return this.getJdbcTemplate().update(sql, new Object[]{i, new Integer(type), globalKey, key});
            ...
            case PropertySet.LONG:
                ...
                Long l = (Long) value;
                sql = "UPDATE " + tableName + " SET " + colNumber + " = ?, " + colItemType + " = ? " + " WHERE " + colGlobalKey + " = ? AND " + colItemKey + " = ?";
                return this.getJdbcTemplate().update(sql, new Object[]{l, new Integer(type), globalKey, key});


            case PropertySet.STRING:
                sql = "UPDATE " + tableName + " SET " + colString + " = ?, " + colItemType + " = ? " + " WHERE " + colGlobalKey + " = ? AND " + colItemKey + " = ?";
                return this.getJdbcTemplate().update(sql, new Object[]{(String) value, new Integer(type), globalKey, key});
    ...
    private void insertValues(int type, String key, Object value) throws DataAccessException, PropertyException {
        ...
        switch (type) {
            case PropertySet.BOOLEAN:
                ...
                this.getJdbcTemplate().update(sql, new Object[]{new Integer(boolVal.booleanValue() ? 1 : 0), new Integer(type), globalKey, key});
                break;
            case PropertySet.DATA:
                ...
                this.getJdbcTemplate().update(sql, new Object[]{data.getBytes(), new Integer(type), globalKey, key});
                break;
            ...
            case PropertySet.DATE:
                ...
                this.getJdbcTemplate().update(sql, new Object[]{new Timestamp(date.getTime()), new Integer(type), globalKey, key});
                break;
            ...
            case PropertySet.DOUBLE:
                ...
                this.getJdbcTemplate().update(sql, new Object[]{d, new Integer(type), globalKey, key});
                break;
            ...
            case PropertySet.INT:
                ...
                sql = "INSERT INTO " + tableName + " (" + colNumber + ", " + colItemType + ", " + colGlobalKey + ", " + colItemKey + ") VALUES (?, ?, ?, ?)";
                this.getJdbcTemplate().update(sql, new Object[]{i, new Integer(type), globalKey, key});
                break;
            ...
            case PropertySet.LONG:
                ...
                Long l = (Long) value;
                sql = "INSERT INTO " + tableName + " (" + colNumber + ", " + colItemType + ", " + colGlobalKey + ", " + colItemKey + ") VALUES (?, ?, ?, ?)";
                this.getJdbcTemplate().update(sql, new Object[]{l, new Integer(type), globalKey, key});
                break;

            case PropertySet.STRING:
                sql = "INSERT INTO " + tableName + " (" + colString + ", " + colItemType + ", " + colGlobalKey + ", " + colItemKey + ") VALUES (?, ?, ?, ?)";
                this.getJdbcTemplate().update(sql, new Object[]{(String) value, new Integer(type), globalKey, key});
                break;
