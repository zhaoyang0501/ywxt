...
<script type="text/javascript">
	$(document).ready(function(){
		$.adminItem.initSearchDataTablework();
		$(".date").datetimepicker({
			language:  'zh-CN',
	        weekStart: 1,
	        todayBtn:  1,
					...
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<div class="box well form-inline">
								...
								<a onclick="$.adminItem.initSearchDataTablework()"
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="form-container grid-form form-background left-align form-horizontal">
						 <form id='_form' action="${pageContext.request.contextPath}/admin/item/dowork"   method="post">
							<input type="hidden" id="itemid" name='item.id' value="">
							<div class="control-group" id='control_project'>
								<label for="category" class="control-label">维修工备注：</label>
								<div class="controls">
									<textarea name='item.workremark' rows="4" cols=""></textarea>
								</div>
							</div>
